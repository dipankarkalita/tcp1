...
export default function TrafficControlStrategies() {
  return (
    <div className="min-h-screen bg-gradient-to-r from-red-50 to-gray-50">
      <div className="container mx-auto px-4 py-12">
        <h1 className="text-4xl md:text-5xl font-bold mb-8 text-center text-gray-800">
          Traffic Control <span className="text-red-600">Strategies</span>
        </h1>
